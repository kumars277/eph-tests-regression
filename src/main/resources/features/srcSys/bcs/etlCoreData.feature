 ...
 #conflunce Veraion: v93
  ...
  Scenario Outline: Verify Data for BCS_ETL Core tables is transferred from Inbound Tables
    ...
    Examples:
      ...
      |etl_person_current_v                         |1              |
      |etl_product_current_v                        |1              |
      |etl_work_person_role_current_v               |1              |
      |etl_work_relationship_current_v              |1              |
      |etl_work_current_v                           |1              |
      |etl_work_identifier_current_v                |1              |
  ...
  Scenario Outline: Verify Data count for BCS core transform_file tables are transferred from current tables
    ...
    Examples:
      ...
      |etl_delta_current_accountable_product      |etl_transform_history_accountable_product_excl_delta               |etl_transform_history_accountable_product_latest      |10               |
      |etl_delta_current_manifestation            |etl_transform_history_manifestation_excl_delta                     |etl_transform_history_manifestation_latest            |10               |
      |etl_delta_current_person                   |etl_transform_history_person_excl_delta                            |etl_transform_history_person_latest                   |10               |
      |etl_delta_current_product                  |etl_transform_history_product_excl_delta                           |etl_transform_history_product_latest                  |10               |
      |etl_delta_current_work_person_role         | etl_transform_history_work_person_role_excl_delta                 |etl_transform_history_work_person_role_latest         |10               |
      |etl_delta_current_work_relationship        |etl_transform_history_work_relationship_excl_delta                 |etl_transform_history_work_relationship_latest        |10               |
      |etl_delta_current_work                     |etl_transform_history_work_excl_delta                              |etl_transform_history_work_latest                     |10               |
      |etl_delta_current_work_identifier          |etl_transform_history_work_identifier_excl_delta                   |etl_transform_history_work_identifier_latest          |10               |
      |etl_delta_current_manifestation_identifier |etl_transform_history_manifestation_identifier_excl_delta          |etl_transform_history_manifestation_identifier_latest |10               |
