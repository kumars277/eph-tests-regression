...
Feature:Validate data for Promis Inbound tables
  ...
  Scenario Outline: Verify that all Promis data is transferred between inbound and current tables
    ...
    Examples:
      ...
      | 50               |promis_prmautpubt_part  |promis_prmautpubt_current  |
      | 50               |promis_prmclscodt_part  |promis_prmclscodt_current  |
      | 50               |promis_prmclst_part     |promis_prmclst_current     |
      | 50               |promis_prm_londes_2_html_part  |promis_prm_londes_2_html_current  |
      | 50               |promis_prmpricest_part  |promis_prmpricest_current  |
      | 50               |promis_prmpubinft_part  |promis_prmpubinft_current  |
      | 50               |promis_prmpubrelt_part  |promis_prmpubrelt_current  |
      | 50               |promis_prmincpmct_part  |promis_prmincpmct_current  |
      | 50               |promis_prmpmccodt_part  |promis_prmpmccodt_current  |
