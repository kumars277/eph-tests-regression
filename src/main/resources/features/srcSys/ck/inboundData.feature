...
#confluence link:https://elsevier.atlassian.net/wiki/spaces/EPH/pages/90784826471/CK+Inbound
  ...
  Scenario Outline: Verify that all CK data is transferred between inbound Source and current tables
    ...
    Examples:
      ...
      | 5              |ck_package_form_v            |ck_transform_current_package                 |
      | 5              |ck_subject_area_form_v       |ck_transform_current_subject_area            |
      | 5              |ck_work_form_v               |ck_transform_current_work                    |
      | 5              |ck_package_work_form_v       |ck_transform_current_package_work            |
      | 5              |ck_work_subject_area_form_v  |ck_transform_current_work_subject_area       |
      | 5              |ck_package_work_url_form_v   |ck_transform_current_package_work_url        |
