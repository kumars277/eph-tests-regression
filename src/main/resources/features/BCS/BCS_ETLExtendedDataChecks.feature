...
#  Created by Dinesh on 14/01/2021
  ...
  Scenario Outline: Verify Data for BCS Extended Delta_Current tables are transferred from Delta_Current Hist Tables
    ...
    Examples:
      |targetTable                                                | sourceTable                                               |countOfRandomIds|
      |etl_delta_current_extended_availability                    |etl_delta_history_extended_availability_part               |50              |
      |etl_delta_current_extended_manifestation                   |etl_delta_history_extended_manifestation_part              |50              |
      |etl_delta_current_extended_page_count                      |etl_delta_history_extended_page_count_part                 |50              |
      |etl_delta_current_extended_url                             |etl_delta_history_extended_url_part                        |50              |
      |etl_delta_current_extended_work                            |etl_delta_history_extended_work_part                       |50              |
      |etl_delta_current_extended_work_subject_area               |etl_delta_history_extended_work_subject_area_part          |50              |
      |etl_delta_current_extended_manifestation_restrictions      |etl_delta_history_extended_manifestation_restrictions_part |50              |
      |etl_delta_current_extended_product_prices                  |etl_delta_history_extended_product_prices_part             |50              |
      |etl_delta_current_extended_work_person_role                |etl_delta_history_extended_work_person_role_part           |50              |
