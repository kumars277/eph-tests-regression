        ...
        if(dataQualityDLContext.tbManifestationDataObjectsFromDL.isEmpty()){
            ...
            for (int i = 0; i < dataQualityDLContext.tbManifestationDataObjectsFromEPH.size(); i++) {
                ...
                if(tableName.equals("gh_manifestation")){
                    dataQualityDLContext.tbManifestationDataObjectsFromEPH.sort(Comparator.comparing(ManifestationDataDLObject::getB_FROMBATCHID));
                    dataQualityDLContext.tbManifestationDataObjectsFromDL.sort(Comparator.comparing(ManifestationDataDLObject::getB_FROMBATCHID));
                }
