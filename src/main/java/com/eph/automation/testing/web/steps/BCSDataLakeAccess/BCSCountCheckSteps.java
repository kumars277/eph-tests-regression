...
public class BCSCountCheckSteps {
    ...
    public void getCountfromPreviousTables(String tableName){
        ...
        switch (tableName){
            ...
            case "stg_previous_content":            BCSPreviousCount_SQL = BCSDataLakeCountCheckSQL.GET_BCS_CONTENT_PREVIOUS_COUNT;break;
            case "stg_previous_extobject":          BCSPreviousCount_SQL = BCSDataLakeCountCheckSQL.GET_BCS_EXTOBJECT_PREVIOUS_COUNT ;break;
            case "stg_previous_fullversionfamily":  BCSPreviousCount_SQL = BCSDataLakeCountCheckSQL.GET_BCS_FULLVERSIONFAMILY_PREVIOUS_COUNT ;break;
            case "stg_previous_originators":        BCSPreviousCount_SQL = BCSDataLakeCountCheckSQL.GET_BCS_ORIGINATORS_PREVIOUS_COUNT ;break;
            case "stg_previous_pricing":            BCSPreviousCount_SQL = BCSDataLakeCountCheckSQL.GET_BCS_PRICING_PREVIOUS_COUNT ;break;
            case "stg_previous_product":            BCSPreviousCount_SQL = BCSDataLakeCountCheckSQL.GET_BCS_PRODUCT_PREVIOUS_COUNT ;break;
            case "stg_previous_production":         BCSPreviousCount_SQL = BCSDataLakeCountCheckSQL.GET_BCS_PRODUCTION_PREVIOUS_COUNT ;break;
            case "stg_previous_relations":          BCSPreviousCount_SQL = BCSDataLakeCountCheckSQL.GET_BCS_RELATIONS_PREVIOUS_COUNT ;break;
            case "stg_previous_responsibilities":   BCSPreviousCount_SQL = BCSDataLakeCountCheckSQL.GET_BCS_RESPONSIBILITIES_PREVIOUS_COUNT ;break;
            case "stg_previous_sublocation":        BCSPreviousCount_SQL = BCSDataLakeCountCheckSQL.GET_BCS_SUBLOCATION_PREVIOUS_COUNT ;break;
            case "stg_previous_text":               BCSPreviousCount_SQL = BCSDataLakeCountCheckSQL.GET_BCS_TEXT_PREVIOUS_COUNT ;break;
            case "stg_previous_versionfamily":      BCSPreviousCount_SQL = BCSDataLakeCountCheckSQL.GET_BCS_VERSIONFAMILY_PREVIOUS_COUNT ;break;
        }
    ...
    public void getCountFromHistoryForPreviousComparision(String tableName){
        ...
        switch (tableName){
            case "stg_history_classification_part":     BCSHistoryCount_SQL = BCSDataLakeCountCheckSQL.GET_BCS_CLASSIFICATION_HISTORY_COUNT;          break;
            case "stg_history_content_part":            BCSHistoryCount_SQL = BCSDataLakeCountCheckSQL.GET_BCS_CONTENT_HISTORY_COUNT;          break;
            case "stg_history_extobject_part":          BCSHistoryCount_SQL = BCSDataLakeCountCheckSQL.GET_BCS_EXTOBJECT_HISTORY_COUNT ;break;
            case "stg_history_fullversionfamily_part":  BCSHistoryCount_SQL = BCSDataLakeCountCheckSQL.GET_BCS_FULLVERSIONFAMILY_HISTORY_COUNT ;break;
            case "stg_history_originators_part":        BCSHistoryCount_SQL = BCSDataLakeCountCheckSQL.GET_BCS_ORIGINATORS_HISTORY_COUNT ;break;
            case "stg_history_pricing_part":            BCSHistoryCount_SQL = BCSDataLakeCountCheckSQL.GET_BCS_PRICING_HISTORY_COUNT ;break;
            case "stg_history_product_part":            BCSHistoryCount_SQL = BCSDataLakeCountCheckSQL.GET_BCS_PRODUCT_HISTORY_COUNT ;break;
            case "stg_history_production_part":         BCSHistoryCount_SQL = BCSDataLakeCountCheckSQL.GET_BCS_PRODUCTION_HISTORY_COUNT ;break;
            case "stg_history_relations_part":          BCSHistoryCount_SQL = BCSDataLakeCountCheckSQL.GET_BCS_RELATIONS_HISTORY_COUNT ;break;
            case "stg_history_responsibilities_part":   BCSHistoryCount_SQL = BCSDataLakeCountCheckSQL.GET_BCS_RESPONSIBILITIES_HISTORY_COUNT ;break;
            case "stg_history_sublocation_part":        BCSHistoryCount_SQL = BCSDataLakeCountCheckSQL.GET_BCS_SUBLOCATION_HISTORY_COUNT ;break;
            case "stg_history_text_part":               BCSHistoryCount_SQL = BCSDataLakeCountCheckSQL.GET_BCS_TEXT_HISTORY_COUNT ;break;
            case "stg_history_versionfamily_part":      BCSHistoryCount_SQL = BCSDataLakeCountCheckSQL.GET_BCS_VERSIONFAMILY_HISTORY_COUNT ;break;
        }
