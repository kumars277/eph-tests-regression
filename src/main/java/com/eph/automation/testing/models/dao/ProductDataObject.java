...
public class ProductDataObject {
    ...
    public String getPRODUCT_SHORT_NAME() {return PRODUCT_SHORT_NAME;}
    public void setPRODUCT_SHORT_NAME(String PRODUCT_SHORT_NAME) {this.PRODUCT_SHORT_NAME = PRODUCT_SHORT_NAME;}
    ...
    public String getELSEVIER_TAX_CODE() {return ELSEVIER_TAX_CODE;}
    public void setELSEVIER_TAX_CODE(String ELSEVIER_TAX_CODE) {this.ELSEVIER_TAX_CODE = ELSEVIER_TAX_CODE;}
    ...
    public void setF_REVENUE_MODEL(String f_REVENUE_MODEL) {F_REVENUE_MODEL = f_REVENUE_MODEL;}
   ...
   public String getF_TYPE() {return F_TYPE;}
    ...
    @Override
    public int hashCode() {
        return Objects.hash(PRODUCT_ID,CREATED,UPDATED, PRODUCT_NAME, PRODUCT_SHORT_NAME, SEPARATELY_SALEABLE_IND, TRIAL_ALLOWED_IND, FIRST_PUB_DATE, ELSEVIER_TAX_CODE, PRODUCT_MANIFESTATION_ID, F_PRODUCT_WORK, F_PRODUCT_MANIFESTATION_TYP, SUBSCRIPTION, BULK_SALES, BACK_FILES, OPEN_ACCESS, REPRINTS, AUTHOR_CHARGES, ONE_OFF_ACCESS, PACKAGES, AVAILABILITY_STATUS, WORK_TITLE, WORK_TYPE, ULT_WORK_REF, TAX_CODE, DQ_ERR, F_EVENT, B_CLASSNAME, F_REVENUE_MODEL, PMX_SOURCE_REFERENCE, F_TYPE, F_STATUS);
    }
