 ...
 * updatec by Nihsant @ 18 May 2020 for latest product finder UI changes
 */
...
public class TasksNew {
    ...
    public WebElement findElement(String locatorType,String locatorValue){
        ...
        switch (locatorType)
        {
            case "XPATH":   element = driver.findElement(By.xpath(locatorValue));  break;
            case "NAME":    element = driver.findElement(By.name(locatorValue));    break;
            case "ID":      element = driver.findElement(By.id(locatorValue));      break;
            case "TAG":     element = driver.findElement(By.tagName(locatorValue)); break;
            case "CSS":     element = driver.findElement(By.cssSelector(locatorValue)); break;
        }
        return element;
    }
    ...
    public List<WebElement> findmultipleElements(String locatorType, String locatorValue){
        ...
        try
        {
            switch (locatorType)
            {
                case "XPATH": elements = driver.findElements(By.xpath(locatorValue));     break;
                case "CLASS": elements = driver.findElements(By.className(locatorValue)); break;
                case "TAG":   elements = driver.findElements(By.tagName(locatorValue));   break;
            }
    ...
    public boolean isObjectpresent(String locatorType,String locatorValue){
        ...
        try {
            ...
            if (element.isDisplayed() && element.isEnabled()) return true; else return false;
        }
    ...
    public void keyboardEvents(String locatorType, String locatorValue, String keyName){
        try{
            ...
            switch (keyName)
            {
               case "RETURN": element.sendKeys(Keys.RETURN); break;
            }
        }
        catch (Exception e)
        {
