...
public class MirrorsDataObject {
    public int stgCount;
    public int pmxCount;
    ...
    public String getWORK_REL_mirror_ID() {
        return WORK_REL_mirror_ID;
    }

    public void setWORK_REL_mirror_ID(String WORK_REL_mirror_ID) {
        this.WORK_REL_mirror_ID = WORK_REL_mirror_ID;
    }
    ...
    public String WORK_REL_mirror_ID;
