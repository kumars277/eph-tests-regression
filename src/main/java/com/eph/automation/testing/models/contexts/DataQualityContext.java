...
public class DataQualityContext {
    ...
    public static List<ManifestationIdentifierObject> manifestationDataObjectsFromSA;
    public static List<ManifestationIdentifierObject> manifestationDataObjectsFromGD;
