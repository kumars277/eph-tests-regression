...
public class CKReportsDataChecksSQL {
    ...
    public static String GET_TRANSACTION_WORKFLOW_VIEW_Data = "select * from " + GetCKDLDB.getCKCMMSDataBase() + ".%s where Work_ID in ('%s') order by work_id, workflow_status, transaction_field_change_id, package_id, to_value, cutoff_date";
    ...
    public static String GET_TRANSACTION_WORKFLOW_TABLE_Data = "select * from " + GetCKDLDB.getCKCMMSDataBase() + ".%s where Work_ID in ('%s') order by work_id, workflow_status, transaction_field_change_id, package_id, to_value, cutoff_date";
}
