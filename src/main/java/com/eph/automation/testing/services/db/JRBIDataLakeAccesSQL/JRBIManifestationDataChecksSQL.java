...
public class JRBIManifestationDataChecksSQL {
    ...
    public static String GET_MANIF_RECORDS_FULL_LOAD =
            /*"select epr as EPR" +
                    ...
                    " LEFT JOIN "+GetBCS_ETLCoreDLDBUser.getProductDatabase()+".eph_identifier_cross_reference_v cr2 ON ((((j.journal_number = cr2.identifier) AND (cr2.identifier_type = 'ELSEVIER JOURNAL NUMBER')) AND (cr2.record_level = 'Manifestation')) AND (cr2.manifestation_type = 'JPR'))))\n" +
                    "where EPR in ('%s')";*/
