...
public  class ManifestationGDGHTablesDataChecksSQL {
    ...
    public String manifestationBuildSql(String db, String tableName){
        String GET_DATA_MANIFESTATION = null;
        switch (tableName){
            case "gd_manifestation":
                GET_DATA_MANIFESTATION = "select \n" +
    ...
    public String manifIdentifierBuildSql(String db,String tableName){
        String GET_DATA_MANI_IDENTIFIER = null;
        switch (tableName){
            case "gd_manifestation_identifier":
                GET_DATA_MANI_IDENTIFIER =  "select \n" +
        ...
        return GET_DATA_MANI_IDENTIFIER;
    }
