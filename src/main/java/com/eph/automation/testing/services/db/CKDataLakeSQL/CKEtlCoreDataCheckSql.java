...
public class CKEtlCoreDataCheckSql {
    ...
    public static String GET_CK_DELTA_CURRENT_PACKAGE_WORK = "select * from " + GetCKDLDB.getCKDataBase() + ".%s where u_key in ('%s')";
    public static String GET_CK_DELTA_CURRENT_WORK_SUBJECT_AREA = "select * from " + GetCKDLDB.getCKDataBase() + ".%s where u_key in ('%s')";

//    GET Delta History Data
    public static String GET_CK_DELTA_HISTORY_PACKAGE_WORK = "select * from " + GetCKDLDB.getCKDataBase() + ".%s where u_key in ('%s')";
    public static String GET_CK_DELTA_HISTORY_WORK_SUBJECT_AREA = "select * from " + GetCKDLDB.getCKDataBase() + ".%s where u_key in ('%s')";
