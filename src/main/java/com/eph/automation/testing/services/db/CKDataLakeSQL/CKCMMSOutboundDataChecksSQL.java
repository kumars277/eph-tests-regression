...
public class CKCMMSOutboundDataChecksSQL {
    ...
    public static String GET_CK_CMMS_WORK2_IDENTIFIERS_VIEW = "select * from " + GetCKDLDB.getCKCMMSDataBase() + ".%s where identifier in ('%s')";
    ...
    public static String GET_CK_CMMS_WORK2_IDENTIFIERS = "select * from " + GetCKDLDB.getCKCMMSDataBase() + ".%s where identifier in ('%s')";
