...
public class BCS_ETLExtendedCountChecksSQL {
    ...
    public static String GET_BCS_EXTENDED_AVAILABILITY_EXTENDED_CURR_COUNT="select count(*) as Target_Count from "+ GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_availability_extended_current_v";

    public static String GET_BCS_EXTENDED_MANIFESTATION_EXTENDED_CURR_COUNT="select count(*) as Target_Count from " + GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_manifestation_extended_current_v";

    public static String GET_BCS_EXTENDED_PAGE_COUNT_EXTENDED_CURR_COUNT="select count(*) as Target_Count from " +GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_page_count_extended_current_v ";

    public static String GET_BCS_EXTENDED_URL_EXTENDED_CURR_COUNT="select count(*) as Target_Count from " +GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_url_extended_current_v";

    public static String GET_BCS_EXTENDED_WORK_EXTENDED_CURR_COUNT="select count(*) as Target_Count from " +GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_work_extended_current_v";

    public static String GET_BCS_EXTENDED_WORK_SUBJECT_AREA_EXTENDED_CURR_COUNT="select count(*) as Target_Count from " +GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_work_subject_area_extended_current_v";

    public static String GET_BCS_EXTENDED_MANIFESTATION_RESTRICTIONS_EXTENDED_CURR_COUNT="select count(*) as Target_Count from " +GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_manifestation_restrictions_extended_current_v";

    public static String GET_BCS_EXTENDED_PRODUCT_PRICES_EXTENDED_CURR_COUNT="select count(*) as Target_Count from " +GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_product_prices_extended_current_v";

    public static String GET_BCS_EXTENDED_WORK_PERSON_ROLE_EXTENDED_CURR_COUNT="select count(*) as Target_Count from " +GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_work_person_role_extended_current_v";

    public static String GET_AVAILABILITY_INBOUND_CURRENT_COUNT=
    ...
    public static String GET_AVAILABILITY_DELTA_CURR_COUNT =
            "select count(*) as Source_Count from "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_delta_current_extended_availability";

    public static String GET_MANIF_EXT_DELTA_CURR_COUNT =
            "select count(*) as Source_Count from "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_delta_current_extended_manifestation";

    public static String GET_PAGE_COUNT_DELTA_CURR_COUNT =
            "select count(*) as Source_Count from "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_delta_current_extended_page_count";

    public static String GET_URL_DELTA_CURR_COUNT =
            "select count(*) as Source_Count from "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_delta_current_extended_url";

    public static String GET_WORK_EXT_DELTA_CURR_COUNT =
            "select count(*) as Source_Count from "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_delta_current_extended_work";

    public static String GET_WORK_SUBJ_AREA_DELTA_CURR_COUNT =
            "select count(*) as Source_Count from "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_delta_current_extended_work_subject_area";

    public static String GET_MANIF_REST_DELTA_CURR_COUNT =
            "select count(*) as Source_Count from "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_delta_current_extended_manifestation_restrictions";

    public static String GET_PROD_PRICE_DELTA_CURR_COUNT =
            "select count(*) as Source_Count from "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_delta_current_extended_product_prices";

    public static String GET_WORK_PERS_ROLE_DELTA_CURR_COUNT =
            "select count(*) as Source_Count from "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_delta_current_extended_work_person_role";

    public static String GET_AVAILABILITY_DELTA_HIST_CURR_COUNT =
            "select count(*) as Target_Count from "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_delta_history_extended_availability_part where " +
                    "delta_ts = (select max(delta_ts) from "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_delta_history_extended_availability_part)";

    public static String GET_MANIF_EXT_DELTA_HIST_CURR_COUNT =
            "select count(*) as Target_Count from "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_delta_history_extended_manifestation_part " +
                    "where delta_ts = (select max(delta_ts) from "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_delta_history_extended_manifestation_part)";

    public static String GET_PAGE_COUNT_DELTA_HIST_CURR_COUNT =
            "select count(*) as Target_Count from "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_delta_history_extended_page_count_part where " +
                    "delta_ts = (select max(delta_ts) from "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_delta_history_extended_page_count_part) ";

    public static String GET_URL_DELTA_HIST_CURR_COUNT =
            "select count(*) as Target_Count from "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_delta_history_extended_url_part where " +
                    "delta_ts = (select max(delta_ts) from "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_delta_history_extended_url_part) ";

    public static String GET_WORK_EXT_DELTA_HIST_CURR_COUNT =
            "select count(*) as Target_Count from "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_delta_history_extended_work_part where " +
                    "delta_ts = (select max(delta_ts) from "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_delta_history_extended_work_part) ";

    public static String GET_WORK_SUBJ_AREA_DELTA_HIST_CURR_COUNT =
            "select count(*) as Target_Count from "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_delta_history_extended_work_subject_area_part where " +
                    "delta_ts = (select max(delta_ts) from "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_delta_history_extended_work_subject_area_part) ";

    public static String GET_MANIF_REST_DELTA_HIST_CURR_COUNT =
            "select count(*) as Target_Count from "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_delta_history_extended_manifestation_restrictions_part where" +
                    " delta_ts = (select max(delta_ts) from "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_delta_history_extended_manifestation_restrictions_part) ";

    public static String GET_PROD_PRICE_DELTA_HIST_COUNT =
            "select count(*) as Target_Count from "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_delta_history_extended_product_prices_part where" +
                    " delta_ts = (select max(delta_ts) from "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_delta_history_extended_product_prices_part) ";

    public static String GET_WORK_PERS_ROLE_DELTA_HIST_COUNT =
            "select count(*) as Target_Count from "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_delta_history_extended_work_person_role_part " +
                    "where delta_ts = (select max(delta_ts) from "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_delta_history_extended_work_person_role_part)";

    public static String GET_AVAILABILITY_CURR_HIST_COUNT =
            "select count(*) as Source_Count from "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_transform_history_extended_availability_part where delete_flag=false and " +
    ...
    public static String GET_MANIF_EXT_CURR_HIST_COUNT =
            "select count(*) as Source_Count from "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_transform_history_extended_manifestation_part where delete_flag=false and " +
    ...
    public static String GET_PAGE_COUNT_CURR_HIST_COUNT =
            "select count(*) as Source_Count from "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_transform_history_extended_page_count_part where delete_flag=false and " +
    ...
    public static String GET_URL_CURR_HIST_COUNT =
            "select count(*) as Source_Count from "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_transform_history_extended_url_part where delete_flag=false and " +
    ...
    public static String GET_WORK_EXT_CURR_HIST_COUNT =
            "select count(*) as Source_Count from "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_transform_history_extended_work_part where delete_flag=false and " +
    ...
    public static String GET_WORK_SUBJ_AREA_CURR_HIST_COUNT =
            "select count(*) as Source_Count from "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_transform_history_extended_work_subject_area_part where delete_flag=false and " +
    ...
    public static String GET_MANIF_REST_CURR_HIST_COUNT =
            "select count(*) as Source_Count from "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_transform_history_extended_manifestation_restrictions_part where delete_flag=false and " +
    ...
    public static String GET_PROD_PRICE_CURR_HIST_COUNT =
            "select count(*) as Source_Count from "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_transform_history_extended_product_prices_part where delete_flag=false and " +
    ...
    public static String GET_WORK_PERS_ROLE_CURR_HIST_COUNT =
            "select count(*) as Source_Count from "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_transform_history_extended_work_person_role_part where delete_flag=false and " +
    ...
    public static String GET_AVAILABILITY_CURR_FILE_COUNT =
            "select count(*) as Source_Count from "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_availability_extended_transform_file_history_part where " +
    ...
    public static String GET_MANIF_EXT_CURR_FILE_COUNT =
            "select count(*) as Source_Count from "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_manifestation_extended_transform_file_history_part where " +
    ...
    public static String GET_PAGE_COUNT_CURR_FILE_COUNT =
            "select count(*) as Source_Count from "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_page_count_extended_transform_file_history_part where " +
    ...
    public static String GET_URL_CURR_FILE_COUNT =
            "select count(*) as Source_Count from "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_url_extended_transform_file_history_part where " +
    ...
    public static String GET_WORK_EXT_CURR_FILE_COUNT =
            "select count(*) as Source_Count from "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_work_extended_transform_file_history_part where " +
    ...
    public static String GET_WORK_SUBJ_AREA_CURR_FILE_COUNT =
            "select count(*) as Source_Count from "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_work_subject_area_extended_transform_file_history_part where " +
    ...
    public static String GET_MANIF_REST_CURR_FILE_COUNT =
            "select count(*) as Source_Count from "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_manifestation_restrictions_extended_transform_file_history_part where " +
    ...
    public static String GET_PROD_PRICE_CURR_FILE_COUNT =
            "select count(*) as Source_Count from "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_product_prices_extended_transform_file_history_part where " +
    ...
    public static String GET_WORK_PERS_ROLE_CURR_FILE_COUNT =
            "select count(*) as Source_Count from "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_work_person_role_extended_transform_file_history_part where " +
    ...
    public static String GET_AVAILABILITY_DIFF_DELTA_AND_HIST_COUNT =
            "select count(*) as Source_Count from \n" +
                    "(select c.u_key from "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_transform_history_extended_availability_part c\n" +
                    "left join "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_delta_current_extended_availability d on c.u_key  = d.u_key \n" +
                    "where d.u_key is null and c.transform_ts = (\n" +
                    "select max(c.transform_ts) from "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_transform_history_extended_availability_part c ))";

    public static String GET_MANIF_EXT_DIFF_DELTA_AND_HIST_COUNT =
            "select count(*) as Source_Count from \n" +
                    "(select c.u_key from "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_transform_history_extended_manifestation_part c\n" +
                    "left join "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_delta_current_extended_manifestation d on c.u_key  = d.u_key \n" +
                    "where d.u_key is null and c.transform_ts = (\n" +
                    "select max(c.transform_ts) from "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_transform_history_extended_manifestation_part c ))";

    public static String GET_PAGE_COUNT_DIFF_DELTA_AND_HIST_COUNT =
            "select count(*) as Source_Count from \n" +
                    "(select c.u_key from "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_transform_history_extended_page_count_part c\n" +
                    "left join "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_delta_current_extended_page_count d on c.u_key  = d.u_key \n" +
                    "where d.u_key is null and c.transform_ts = (\n" +
                    "select max(c.transform_ts) from "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_transform_history_extended_page_count_part c ))";

    public static String GET_URL_DIFF_DELTA_AND_HIST_COUNT =
            "select count(*) as Source_Count from \n" +
                    "(select c.u_key from "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_transform_history_extended_url_part c\n" +
                    "left join "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_delta_current_extended_url d on c.u_key  = d.u_key \n" +
                    "where d.u_key is null and c.transform_ts = (\n" +
                    "select max(c.transform_ts) from "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_transform_history_extended_url_part c ))";


    public static String GET_WORK_EXT_DIFF_DELTA_AND_HIST_COUNT =
            "select count(*) as Source_Count from \n" +
                    "(select c.u_key from "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_transform_history_extended_work_part c\n" +
                    "left join "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_delta_current_extended_work d on c.u_key  = d.u_key \n" +
                    "where d.u_key is null and c.transform_ts = (\n" +
                    "select max(c.transform_ts) from "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_transform_history_extended_work_part c ))";

    public static String GET_WRK_SUBJ_AREA_DIFF_DELTA_AND_HIST_COUNT =
            "select count(*) as Source_Count from \n" +
                    "(select c.u_key from "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_transform_history_extended_work_subject_area_part c\n" +
                    "left join "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_delta_current_extended_work_subject_area d on c.u_key  = d.u_key \n" +
                    "where d.u_key is null and c.transform_ts = (\n" +
                    "select max(c.transform_ts) from "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_transform_history_extended_work_subject_area_part c ))";

    public static String GET_MANIF_RESTRICT_DIFF_DELTA_AND_HIST_COUNT =
            "select count(*) as Source_Count from \n" +
                    "(select c.u_key from "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_transform_history_extended_manifestation_restrictions_part c\n" +
                    "left join "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_delta_current_extended_manifestation_restrictions d on c.u_key  = d.u_key \n" +
                    "where d.u_key is null and c.transform_ts = (\n" +
                    "select max(c.transform_ts) from "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_transform_history_extended_manifestation_restrictions_part c ))";

    public static String GET_PROD_PRICE_DIFF_DELTA_AND_HIST_COUNT =
            "select count(*) as Source_Count from \n" +
                    "(select c.u_key from "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_transform_history_extended_product_prices_part c\n" +
                    "left join "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_delta_current_extended_product_prices d on c.u_key  = d.u_key \n" +
                    "where d.u_key is null and c.transform_ts = (\n" +
                    "select max(c.transform_ts) from "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_transform_history_extended_product_prices_part c ))";
    ...
    public static String GET_WORK_PERS_ROLE_DIFF_DELTA_AND_HIST_COUNT =
            "select count(*) as Source_Count from \n" +
                    ...
                    "where d.u_key is null and c.transform_ts = (\n" +
                    "select max(c.transform_ts) from "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_transform_history_extended_work_person_role_part c ))";


    public static String GET_AVAILABILITY_EXCL_COUNT =
            "select count(*)as Target_Count from "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_transform_history_extended_availability_excl_delta";

    public static String GET_MANIF_EXT_EXCL_COUNT =
            "select count(*)as Target_Count from "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_transform_history_extended_manifestation_excl_delta";

    public static String GET_PAGE_COUNT_EXCL_COUNT =
            "select count(*)as Target_Count from "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_transform_history_extended_page_count_excl_delta";

    public static String GET_URL_EXCL_COUNT =
            "select count(*)as Target_Count from "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_transform_history_extended_url_excl_delta";

    public static String GET_WRK_EXT_EXCL_COUNT =
            "select count(*)as Target_Count from "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_transform_history_extended_work_excl_delta";

    public static String GET_WRK_SUBJ_AREA_EXCL_COUNT =
            "select count(*)as Target_Count from "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_transform_history_extended_work_subject_area_excl_delta";

    public static String GET_MANIF_RESTRICT_EXCL_COUNT =
            "select count(*)as Target_Count from "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_transform_history_extended_manifestation_restrictions_excl_delta";

    public static String GET_PROD_PRICE_EXCL_COUNT =
            "select count(*)as Target_Count from "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_transform_history_extended_product_prices_excl_delta";

    public static String GET_WORK_PERS_ROLE_EXCL_COUNT =
            "select count(*)as Target_Count from "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_transform_history_extended_work_person_role_excl_delta";


    public static String GET_AVAILABILITY_SUM_DELTACURR_EXCL_COUNT =
            "select count(*) as source_count from \n" +
                    "(select c.u_key from "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_transform_history_extended_availability_excl_delta as c union all \n" +
                    "select d.u_key from "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_delta_current_extended_availability as d)";

    public static String GET_MANIF_EXT_SUM_DELTACURR_EXCL_COUNT =
            "select count(*) as source_count from \n" +
                    "(select c.u_key from "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_transform_history_extended_manifestation_excl_delta as c union all \n" +
                    "select d.u_key from "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_delta_current_extended_manifestation as d)";

    public static String GET_PAGE_COUNT_SUM_DELTACURR_EXCL_COUNT =
            "select count(*) as source_count from \n" +
                    "(select c.u_key from "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_transform_history_extended_page_count_excl_delta as c union all \n" +
                    "select d.u_key from "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_delta_current_extended_page_count as d)";

    public static String GET_URL_SUM_DELTACURR_EXCL_COUNT =
            "select count(*) as source_count from \n" +
                    "(select c.u_key from "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_transform_history_extended_url_excl_delta as c union all \n" +
                    "select d.u_key from "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_delta_current_extended_url as d)";

    public static String GET_WRK_EXT_SUM_DELTACURR_EXCL_COUNT =
            "select count(*) as source_count from \n" +
                    "(select c.u_key from "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_transform_history_extended_work_excl_delta as c union all \n" +
                    "select d.u_key from "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_delta_current_extended_work as d)";

    public static String GET_WRK_SUBJ_AREA_SUM_DELTACURR_EXCL_COUNT =
            "select count(*) as source_count from \n" +
                    "(select c.u_key from "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_transform_history_extended_work_subject_area_excl_delta as c union all \n" +
                    "select d.u_key from "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_delta_current_extended_work_subject_area as d)";

    public static String GET_MANIF_RESTRICT_SUM_DELTACURR_EXCL_COUNT =
            "select count(*) as source_count from \n" +
                    "(select c.u_key from "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_transform_history_extended_manifestation_restrictions_excl_delta as c union all \n" +
                    "select d.u_key from "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_delta_current_extended_manifestation_restrictions as d)";

    public static String GET_ROD_PRICE_SUM_DELTACURR_EXCL_COUNT =
            "select count(*) as source_count from \n" +
                    "(select c.u_key from "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_transform_history_extended_product_prices_excl_delta as c union all \n" +
                    "select d.u_key from "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_delta_current_extended_product_prices as d)";
    ...
    public static String GET_WORK_PERS_ROLE_SUM_DELTACURR_EXCL_COUNT =
            "select count(*) as source_count from \n" +
                    ...
                    "select d.u_key from "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_delta_current_extended_work_person_role as d)";

    public static String GET_AVAILABILITY_LATEST_COUNT =
            "select count(*)as Target_Count from "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_transform_history_extended_availability_latest";

    public static String GET_MANIF_EXT_LATEST_COUNT =
            "select count(*)as Target_Count from "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_transform_history_extended_manifestation_latest";

    public static String GET_PAGE_COUNT_LATEST_COUNT =
            "select count(*)as Target_Count from "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_transform_history_extended_page_count_latest";

    public static String GET_URL_LATEST_COUNT =
            "select count(*)as Target_Count from "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_transform_history_extended_url_latest";

    public static String GET_WRK_EXT_LATEST_COUNT =
            "select count(*)as Target_Count from "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_transform_history_extended_work_latest";

    public static String GET_WRK_SUBJ_AREA_LATEST_COUNT =
            "select count(*)as Target_Count from "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_transform_history_extended_work_subject_area_latest";

    public static String GET_MANIF_RESTRICT_LATEST_COUNT =
            "select count(*)as Target_Count from "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_transform_history_extended_manifestation_restrictions_latest";

    public static String GET_WRK_PERSON_ROLE_LATEST_COUNT =
            "select count(*)as Target_Count from "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_transform_history_extended_work_person_role_latest";


    public static String GET_PROD_PRICE_LATEST_COUNT =
            "select count(*)as Target_Count from "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_transform_history_extended_product_prices_latest";

    public static String GET_DUPLICATES_LATEST_AVAILABILITY_COUNT =
            "select count(*) as Duplicate_Count " +
                    "from (SELECT count(*) FROM "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_transform_history_extended_availability_latest where delete_flag = false " +
                    "group by u_key having count(*)>1)";

    public static String GET_DUPLICATES_LATEST_MANIF_EXT_COUNT =
            "select count(*) as Duplicate_Count " +
                    "from (SELECT count(*) FROM "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_transform_history_extended_manifestation_latest where delete_flag = false " +
                    "group by u_key having count(*)>1)";

    public static String GET_DUPLICATES_LATEST_PAGE_COUNT_COUNT =
            "select count(*) as Duplicate_Count " +
                    "from (SELECT count(*) FROM "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_transform_history_extended_page_count_latest where delete_flag = false " +
                    "group by u_key having count(*)>1)";

    public static String GET_DUPLICATES_LATEST_URL_COUNT =
            "select count(*) as Duplicate_Count " +
                    "from (SELECT count(*) FROM "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_transform_history_extended_url_latest where delete_flag = false " +
                    "group by u_key having count(*)>1)";

    public static String GET_DUPLICATES_LATEST_WORK_EXT_COUNT =
            "select count(*) as Duplicate_Count " +
                    "from (SELECT count(*) FROM "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_transform_history_extended_work_latest where delete_flag = false " +
                    "group by u_key having count(*)>1)";

    public static String GET_DUPLICATES_LATEST_WORK_SUBJ_AREA_COUNT =
            "select count(*) as Duplicate_Count " +
                    "from (SELECT count(*) FROM "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_transform_history_extended_work_subject_area_latest where delete_flag = false " +
                    "group by u_key having count(*)>1)";

    public static String GET_DUPLICATES_LATEST_MANIF_RESTRICT_COUNT =
            "select count(*) as Duplicate_Count " +
                    "from (SELECT count(*) FROM "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_transform_history_extended_manifestation_restrictions_latest where delete_flag = false " +
                    "group by u_key having count(*)>1)";

    public static String GET_DUPLICATES_LATEST_PROD_PRICE_COUNT =
            "select count(*) as Duplicate_Count " +
                    "from (SELECT count(*) FROM "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_transform_history_extended_product_prices_latest where delete_flag = false " +
                    "group by u_key having count(*)>1)";

    public static String GET_DUPLICATES_LATEST_WORK_PERS_ROLE_COUNT =
            "select count(*) as Duplicate_Count " +
                    "from (SELECT count(*) FROM "+GetBCS_ETLExtendedDLDBUser.getBCS_ETLCoreDataBase()+".etl_transform_history_extended_work_person_role_latest where delete_flag = false " +
                    "group by u_key having count(*)>1)";
