...
public  class WorksDataChecksSQL {
    ...
    public static String GET_RANDOM_WORK_ID = "select work_id as WORK_ID from semarchy_eph_mdm.gd_wwork order by random() limit '%s'";
...
/*    public static String GET_DATA_WORKS_EPH = "select \n" +
    ...
    public static String GET_DATA_WORKS_DL = "select \n" +
            "WORK_ID as WORK_ID\n" +
            ",B_CLASSNAME as B_CLASSNAME\n" +
            ",B_BATCHID as B_BATCHID\n" +
            ",B_CREDATE as B_CREDATE\n" +
