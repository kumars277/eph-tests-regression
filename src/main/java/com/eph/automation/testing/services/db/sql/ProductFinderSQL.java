...
public class ProductFinderSQL {
    ...
    public static String SELECT_MANIFESTATIONID_TITLE_FOR_SEARCH = "select manifestation_id as MANIFESTATION_ID, manifestation_key_title as MANIFESTATION_TITLE, f_wwork as MANIFESTATION_WORK_ID from semarchy_eph_mdm.gd_manifestation order by random() limit 1";
