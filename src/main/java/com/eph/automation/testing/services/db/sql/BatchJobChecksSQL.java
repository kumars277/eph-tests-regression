...
public class BatchJobChecksSQL {
    ...
    public static String GET_BATCH_JOB_STATUS_FROM_MTA = "select count(*) AS JOBS_DONE from semarchy_repository.MTA_JOB_LOG_PARAM JLP, semarchy_repository.MTA_JOB_LOG JL where JLP.PARAM_NAME='V_BATCHID' \n" +
