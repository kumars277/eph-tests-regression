...
public  class PersonGDGHTablesDataChecksSQL {
    ...
    public static String GET_DATA_PERSON_EPH = "select \n" +
    ...
    public static String GET_DATA_PERSON_DL = "select \n" +
            "PERSON_ID as PERSON_ID\n" +
            ",B_CLASSNAME as B_CLASSNAME\n" +
            ",B_BATCHID as B_BATCHID\n" +
            ",B_CREDATE as B_CREDATE\n" +
            ...
            ",EMAIL as EMAIL\n" +
            ",S_EMAIL as S_EMAIL\n" +
            "from product_database_sit.gd_person \n" +
            "where PERSON_ID in ('%s')";


    public static String GET_DATA_GH_PERSON_EPH = "select \n" +
            "PERSON_ID as PERSON_ID\n" +
            ",B_CLASSNAME as B_CLASSNAME\n" +
            ...
            ",EMAIL as EMAIL\n" +
            ",S_EMAIL as S_EMAIL\n" +
            "from semarchy_eph_mdm.gh_person \n" +
            "where PERSON_ID in ('%s')";

    public static String GET_DATA_GH_PERSON_DL = "select \n" +
            "PERSON_ID as PERSON_ID\n" +
            ",B_CLASSNAME as B_CLASSNAME\n" +
            ",B_FROMBATCHID as B_FROMBATCHID\n" +
            ",B_TOBATCHID as B_TOBATCHID\n" +
            ...
            ",EMAIL as EMAIL\n" +
            ",S_EMAIL as S_EMAIL\n" +
            "from product_database_sit.gh_person \n" +
            "where PERSON_ID in ('%s')";
}