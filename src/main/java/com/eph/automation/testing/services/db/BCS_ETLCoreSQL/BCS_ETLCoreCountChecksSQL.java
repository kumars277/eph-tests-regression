...
public class BCS_ETLCoreCountChecksSQL {
    ...
    public static String GET_BCS_ETL_CORE_ACC_PROD_PREV_COUNT =
            "select count(*) as Target_Count from "+GetBCS_ETLCoreDLDBUser.getBCS_ETLCoreDataBase()+".etl_accountable_product_previous_v";
    ...
    public static String GET_BCS_ETL_CORE_MANIF_PREV_COUNT =
            "select count(*) as Target_Count from "+GetBCS_ETLCoreDLDBUser.getBCS_ETLCoreDataBase()+".etl_manifestation_previous_v";
    ...
    public static String GET_BCS_ETL_CORE_PERSON_PREV_COUNT =
            "select count(*) as Target_Count from "+GetBCS_ETLCoreDLDBUser.getBCS_ETLCoreDataBase()+".etl_person_previous_v";
    ...
    public static String GET_BCS_ETL_CORE_PRODUCT_PREV_COUNT =
            "select count(*) as Target_Count from "+GetBCS_ETLCoreDLDBUser.getBCS_ETLCoreDataBase()+".etl_product_previous_v";
    ...
    public static String GET_BCS_ETL_CORE_WRK_PERS_PREV_COUNT =
            "select count(*) as Target_Count from "+GetBCS_ETLCoreDLDBUser.getBCS_ETLCoreDataBase()+".etl_work_person_role_previous_v";
    ...
    public static String GET_BCS_ETL_CORE_WRK_RELT_PREV_COUNT =
            "select count(*) as Target_Count from "+GetBCS_ETLCoreDLDBUser.getBCS_ETLCoreDataBase()+".etl_work_relationship_previous_v";
    ...
    public static String GET_BCS_ETL_CORE_WRK_PREV_COUNT =
            "select count(*) as Target_Count from "+GetBCS_ETLCoreDLDBUser.getBCS_ETLCoreDataBase()+".etl_work_previous_v";
    ...
    public static String GET_BCS_ETL_CORE_WRK_IDENTIF_PREV_COUNT =
            "select count(*) as Target_Count from "+GetBCS_ETLCoreDLDBUser.getBCS_ETLCoreDataBase()+".etl_work_identifier_previous_v";
    ...
    public static String GET_BCS_ETL_CORE_MANIF_IDENTIF_PREV_COUNT =
            "select count(*) as Target_Count from "+GetBCS_ETLCoreDLDBUser.getBCS_ETLCoreDataBase()+".etl_manifestation_identifier_previous_v";
    ...
    public static String GET_ACC_PROD_INBOUND_PREVIOUS_COUNT =
            "SELECT count(*) as Source_Count\n" +
                    " FROM(( \n" +
                    "      SELECT DISTINCT \n" +
                    "      NULLIF(sourceref, '')sourceref \n" +
                    ...
                    "      , concat (NULLIF(sourceref, ''), NULLIF(accountableparent, '')) u_key \n" +
                    "      , 'N' dq_err \n" +
                    "      FROM( "+GetBCS_ETLCoreDLDBUser.getBCS_ETLCoreDataBase()+".stg_previous_classification classification \n" +
                    "      LEFT JOIN "+ GetBCS_ETLCoreDLDBUser.getBCS_ETLCoreDataBase()+".worktypecode ON (split_part(classification.value, ' | ', 1) = ppmcode))\n" +
                    "      WHERE (classification.classificationcode = 'DCDFAC | Accounting class'))) A \n" +
                    "WHERE ((A.sourceref IS NOT NULL) AND (A.accountableparent IS NOT NULL))";


    public static String GET_MANIF_INBOUND_PREVIOUS_COUNT =
            "select count(*) as Source_Count from( \n" +
                    "SELECT DISTINCT product.sourceref, content.title, (CASE WHEN (intedition.classificationcode IS NULL) \n" +
                    "THEN false ELSE true END) intereditionflag, cast((date_parse(COALESCE(NULLIF(firstactual,''),\n" +
                    "NULLIF(firstplanned,'')),'%d-%b-%Y')) as date ) firstpublisheddate, product.binding, \n" +
                    "manifestationtypecode.ephcode manifestation_type, manifestationstatus.ephmanifestationcode status \n" +
                    "   , workprod.workmasterprojectno work_id, CAST(NULL AS timestamp)last_pub_date, 'N' dq_err \n" +
                    "   from ((((((("+GetBCS_ETLCoreDLDBUser.getBCS_ETLCoreDataBase()+".stg_previous_product product \n" +
                    "   INNER JOIN "+GetBCS_ETLCoreDLDBUser.getBCS_ETLCoreDataBase()+".stg_previous_content content ON (product.sourceref = content.sourceref))\n" +
                    "   INNER JOIN "+GetBCS_ETLCoreDLDBUser.getBCS_ETLCoreDataBase()+".stg_previous_versionfamily workprod ON ((product.sourceref = workprod.sourceref) AND (workprod.workmasterprojectno IS NOT NULL)))\n" +
                    "   LEFT JOIN (\n" +
                    "      SELECT sourceref, classificationcode \n" +
                    "      FROM "+GetBCS_ETLCoreDLDBUser.getBCS_ETLCoreDataBase()+".stg_previous_classification classification \n" +
                    "      WHERE (classificationcode LIKE 'PARELIE%') \n" +
                    ...
                    "   LEFT JOIN (\n" +
                    "      SELECT sourceref, min(plannedpubdate) firstplanned \n" +
                    "      FROM "+GetBCS_ETLCoreDLDBUser.getBCS_ETLCoreDataBase()+".stg_previous_sublocation sublocation \n" +
                    "      WHERE (plannedpubdate <> '') GROUP BY sourceref \n" +
                    "   ) planneddates ON (product.sourceref = planneddates.sourceref))\n" +
                    "   LEFT JOIN (\n" +
                    "      select sourceref, min(pubdateactual) firstactual \n" +
    ...
    public static String GET_PERSON_INBOUND_PREVIOUS_COUNT =
            "SELECT count(*) as Source_Count \n" +
                    "FROM \n" +
                    "  ( \n" +
                    "   SELECT DISTINCT \n" +
                    ...
                    "   , CAST(null AS varchar) email_address \n" +
                    "   , 'N' dq_err \n" +
                    "   FROM "+GetBCS_ETLCoreDLDBUser.getBCS_ETLCoreDataBase()+".stg_previous_originators \n" +
                    ")  A \n" +
                    " WHERE (A.sourceref IS NOT NULL)";


    public static String GET_PRODUCT_INBOUND_PREVIOUS_COUNT =
            "SELECT count(*) as Source_Count \n" +
                    "FROM \n" +
                    "  ( \n" +
                    "   SELECT DISTINCT \n" +
                    ...
                    "   , 'N' dq_err \n" +
                    "   FROM \n" +
                    "     (((((("+GetBCS_ETLCoreDLDBUser.getBCS_ETLCoreDataBase()+".stg_previous_product product \n" +
                    "   INNER JOIN "+GetBCS_ETLCoreDLDBUser.getBCS_ETLCoreDataBase()+".stg_previous_content content ON (product.sourceref = content.sourceref))\n" +
                    "   INNER JOIN "+GetBCS_ETLCoreDLDBUser.getBCS_ETLCoreDataBase()+".stg_previous_fullversionfamily fullversionfamily ON ((product.sourceref = fullversionfamily.sourceref) AND (workmaster = 'YES')))\n" +
                    "   INNER JOIN "+GetBCS_ETLCoreDLDBUser.getBCS_ETLCoreDataBase()+".etl_work_previous_v workcontent ON (fullversionfamily.projectno = workcontent.sourceref))\n" +
                    "   INNER JOIN "+GetBCS_ETLCoreDLDBUser.getBCS_ETLCoreDataBase()+".stg_previous_classification classification ON ((product.sourceref = classification.sourceref) AND (classificationcode = 'DCDFAC | Accounting class')))\n" +
                    "   LEFT JOIN "+GetBCS_ETLCoreDLDBUser.getBCS_ETLCoreDataBase()+".taxcode ON (split_part(classification.value, ' | ', 1) = taxcode.ppmcode))\n" +
                    "   LEFT JOIN (\n" +
                    "      SELECT DISTINCT\n" +
                    "        sourceref \n" +
                    ...
                    "           sourceref \n" +
                    "         , min (priority) statuspriority \n" +
                    "         FROM ("+GetBCS_ETLCoreDLDBUser.getBCS_ETLCoreDataBase()+".stg_previous_sublocation\n" +
                    "         INNER JOIN "+GetBCS_ETLCoreDLDBUser.getBCS_ETLCoreDataBase()+".statuscode ON (split_part(status, ' | ', 1) = ppmcode))\n" +
                    "         GROUP BY sourceref \n" +
                    "      )  masterstatus \n" +
                    "      INNER JOIN "+GetBCS_ETLCoreDLDBUser.getBCS_ETLCoreDataBase()+".statuscode ON (statuspriority = priority))\n" +
    ...
    public static String GET_WRK_PERSON_INBOUND_PREVIOUS_COUNT =
            "SELECT count(*) as Source_Count \n" +
                    "FROM \n" +
                    "  ( \n" +
                    "   SELECT DISTINCT\n" +
                    ...
                    "   , 'N' dq_err \n" +
                    "   FROM \n" +
                    "     ("+GetBCS_ETLCoreDLDBUser.getBCS_ETLCoreDataBase()+".stg_previous_originators \n" +
                    "   INNER JOIN "+GetBCS_ETLCoreDLDBUser.getBCS_ETLCoreDataBase()+".rolecode ON (split_part(copyrightholdertype, ' | ', 1) = rolecode.ppmcode)) \n" +
                    "UNION    SELECT \n" +
                    "     NULLIF(sourceref, '') worksourceref \n" +
                    "   , NULLIF(personid, '') personsourceref \n" +
                    ...
                    "   , 'N' dq_err \n" +
                    "   FROM \n" +
                    "     ("+GetBCS_ETLCoreDLDBUser.getBCS_ETLCoreDataBase()+".stg_previous_responsibilities \n" +
                    "   INNER JOIN "+GetBCS_ETLCoreDLDBUser.getBCS_ETLCoreDataBase()+".rolecode ON (split_part(responsibility, ' | ', 1) = rolecode.ppmcode))\n" +
                    ")  A \n" +
                    "WHERE (((A.worksourceref IS NOT NULL) AND (A.personsourceref IS NOT NULL)) AND (A.roletype IS NOT NULL))";

    public static String GET_WRK_RELT_INBOUND_PREVIOUS_COUNT =
            "select count(*) as Source_Count from( \n" +
                    "SELECT \n" +
                    "     concat(concat(CAST(sourceref AS varchar), split_part(relationtype, ' | ', 1)), CAST(projectno AS varchar)) sourceref \n" +
                    "   , sourceref parentref \n" +
                    ...
                    "   , 'N' dq_err \n" +
                    "   FROM \n" +
                    "     ("+GetBCS_ETLCoreDLDBUser.getBCS_ETLCoreDataBase()+".stg_previous_relations \n" +
                    "   INNER JOIN "+GetBCS_ETLCoreDLDBUser.getBCS_ETLCoreDataBase()+".relationtypecode ON \n" +
                    "   (split_part(relationtype, ' | ', 1) = relationtypecode.ppmcode)))";

    public static String GET_WRK_INBOUND_PREVIOUS_COUNT =
            "SELECT count(*)as Source_Count \n" +
                    "FROM \n" +
                    "  ( \n" +
                    "   SELECT DISTINCT\n" +
                    ...
                    "   , date_parse(NULLIF(content.metamodifiedon, ''),'%d-%b-%Y %H:%i:%s') modifiedon \n" +
                    "   FROM \n" +
                    "     (((((("+GetBCS_ETLCoreDLDBUser.getBCS_ETLCoreDataBase()+".stg_previous_content content \n" +
                    "   INNER JOIN "+GetBCS_ETLCoreDLDBUser.getBCS_ETLCoreDataBase()+".stg_previous_versionfamily versionfamily ON (content.sourceref = versionfamily.workmasterprojectno)) \n" +
                    "   LEFT JOIN "+GetBCS_ETLCoreDLDBUser.getBCS_ETLCoreDataBase()+".stg_previous_classification classification ON ((content.sourceref = classification.sourceref) AND (classification.classificationcode = 'DCDFAC | Accounting class'))) \n" +
                    "   LEFT JOIN ( \n" +
                    "      SELECT DISTINCT \n" +
                    "        masterstatus.sourceref \n" +
                    "      , statuscode.ephworkcode \n" +
                    ...
                    "         , min(priority) statuspriority \n" +
                    "         FROM \n" +
                    "           (("+GetBCS_ETLCoreDLDBUser.getBCS_ETLCoreDataBase()+".stg_previous_versionfamily versionfamily \n" +
                    "         INNER JOIN "+GetBCS_ETLCoreDLDBUser.getBCS_ETLCoreDataBase()+".stg_previous_sublocation sublocation ON (versionfamily.sourceref = sublocation.sourceref))\n" +
                    "         INNER JOIN "+GetBCS_ETLCoreDLDBUser.getBCS_ETLCoreDataBase()+".statuscode ON (split_part(sublocation.status, ' | ', 1) = statuscode.ppmcode))\n" +
                    "         GROUP BY workmasterprojectno \n" +
                    "      )  masterstatus ON (statuscode.priority = masterstatus.statuspriority))\n" +
                    "   )  status ON (content.sourceref = status.sourceref))\n" +
    ...
    public static String GET_WRK_IDENTIF_INBOUND_PREVIOUS_COUNT =
            "WITH \n" +
                    "  work_id AS ( \n" +
                    "   SELECT DISTINCT workmasterprojectno \n" +
                    "   FROM "+GetBCS_ETLCoreDLDBUser.getBCS_ETLCoreDataBase()+".stg_previous_versionfamily \n" +
                    ")\n" +
                    "select count(*) as Source_Count from(\n" +
                    "SELECT\n" +
                    "  sourceref \n" +
    ...
    public static String GET_MANIF_IDENTIF_INBOUND_PREVIOUS_COUNT =
            "select count(*) as Source_Count from( \n" +
                    "SELECT \n" +
                    "     sourceref \n" +
                    "   , isbn13 identifier \n" +
                    "   , 'ISBN' identifier_type \n" +
                    "   FROM "+GetBCS_ETLCoreDLDBUser.getBCS_ETLCoreDataBase()+".stg_previous_product \n" +
                    "   WHERE (isbn13 <> '') \n" +
                    " UNION ALL SELECT \n" +
                    "     sourceref \n" +
                    "   , seriesissn identifier \n" +
                    "   , 'ISSN' identifier_type \n" +
                    "   FROM "+GetBCS_ETLCoreDLDBUser.getBCS_ETLCoreDataBase()+".stg_previous_content\n" +
                    "   WHERE (seriesissn <> ''))";
