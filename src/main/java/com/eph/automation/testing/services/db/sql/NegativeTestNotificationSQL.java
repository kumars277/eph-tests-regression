...
public class NegativeTestNotificationSQL {
    ...
    public static String Manifestation_1_Negative_1 = "INSERT INTO ephsit.semarchy_eph_mdm.sa_manifestation (b_loadid, manifestation_id,\n" +
    ...
    public static String Manifestation_2_Negative_1 = "INSERT INTO ephsit.semarchy_eph_mdm.sa_manifestation \n" +
    ...
    public static String Product_1_Negative_1="INSERT INTO ephsit.semarchy_eph_mdm.sa_product (b_loadid, product_id, b_classname, name,short_name,f_type, f_status,f_manifestation, f_event)\n"+
    ...
    public static String Product_2_Negative_1 = "INSERT INTO ephsit.semarchy_eph_mdm.sa_product (b_loadid, product_id, b_classname, name,short_name,f_type, f_status,f_manifestation, f_event)"+
    ...
    public static String Manifestation_1_Negative_2 = "INSERT INTO ephsit.semarchy_eph_mdm.sa_manifestation " +
            "(b_loadid, manifestation_id, b_classname,manifestation_key_title,f_type,f_status,f_wwork,f_event)\n" +
            "VALUES ('LOADID','EPR-M-TSTM30','Manifestation','The Human Body test','PSB','MPU','EPR-W-TSTW20','EVENT')";

    public static String Manifestation_2_Negative_2 = "INSERT INTO ephsit.semarchy_eph_mdm.sa_manifestation " +
            "(b_loadid, manifestation_id, b_classname,manifestation_key_title,f_type,f_status,f_wwork,f_event)\n" +
            "VALUES ('LOADID','EPR-M-TSTM40','Manifestation','The Human Body test','UNK','MPU','EPR-W-TSTW20','EVENT')";

    public static String Product_1_Negative_2 = "INSERT INTO ephsit.semarchy_eph_mdm.sa_product " +
            "(b_loadid, product_id, b_classname, name,short_name,f_type, f_status,f_manifestation, f_event)\n" +
            "VALUES ('LOADID','EPR-TSTP30','Product','Test The Human Body  Purchase','Carlson-The Human Body','OOA','PAS','EPR-M-TSTM30','EVENT')";

    public static String Product_2_Negative_2 ="INSERT INTO ephsit.semarchy_eph_mdm.sa_product " +
            "(b_loadid, product_id, b_classname, name,short_name,f_type, f_status,f_manifestation, f_event)\n" +
            "VALUES ('LOADID','EPR-TSTP40','Product','Test The Human Body  Purchase','Carlson-The Human Body','OOA','PAS','EPR-M-TSTM40','EVENT')";
}
