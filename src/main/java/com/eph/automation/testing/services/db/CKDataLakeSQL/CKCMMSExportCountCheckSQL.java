...
public class CKCMMSExportCountCheckSQL {
    //  CMMS View Count SQL
    public static String GET_CMMS_WORKFLOW_VIEW_INBOUND_COUNT =
    ...
    public static String GET_CMMS_WORKFLOW_VIEW_COUNT = "select count(*) as COUNT from "+GetCKDLDB.getCKCMMSDataBase()+".cmms_workflow_v";

    public static String GET_CMMS_WORK1_INBOUND_COUNT =
            "select count(*) as COUNT from(\n" +
                    "(\n" +
                    "   SELECT\n" +
    ...
    public static String GET_CMMS_WORK1_VIEW_COUNT = "select count(*) as COUNT from "+GetCKDLDB.getCKCMMSDataBase()+".cmms_work1_v";

    public static String GET_CMMS_WORK2_IDENTIFIERS_INBOUND_COUNT =
            "select count(*) as COUNT from(\n" +
                    "(\n" +
                    "   SELECT\n" +
                    "     workId\n" +
                    ...
                    ") " +
                    ")";
    public static String GET_CMMS_WORK2_IDENTIFIERS_VIEW_COUNT = "select count(*) as COUNT from "+GetCKDLDB.getCKCMMSDataBase()+".cmms_work2_identifiers_v";

    public static String GET_CMMS_WORK3_SUBJ_AREA_INBOUND_COUNT =
                "select count(*) as COUNT from (\n" +
                        "(\n" +
                        "   SELECT\n" +
                        "     workId\n" +
    ...
    public static String GET_CMMS_WORK3_SUBJ_AREA_VIEW_COUNT = "select count(*) as COUNT from "+GetCKDLDB.getCKCMMSDataBase()+".cmms_work3_subject_areas_v";

    public static String GET_CMMS_PKG1_INBOUND_COUNT =
            "select count(*) as COUNT from(\n" +
                    "(\n" +
                    "   SELECT\n" +
                    "     p.work_id packageId\n" +
    ...
    public static String GET_CMMS_PKG1_VIEW_COUNT = "select count(*) as COUNT from "+GetCKDLDB.getCKCMMSDataBase()+".cmms_package1_v";

    public static String GET_CMMS_PKG2_WORKS_INBOUND_COUNT =
            "select count(*) as COUNT from(\n" +
                    "(\n" +
                    "   SELECT\n" +
                    "     workId\n" +
    ...
    public static String GET_CMMS_PKG2_WORKS_VIEW_COUNT = "select count(*) as COUNT from "+GetCKDLDB.getCKCMMSDataBase()+".cmms_package2_works_v";
