...
//            " and TO_TIMESTAMP(\"UPDATED\",'YYYYMMDDHH24MI') > TO_TIMESTAMP('201905201200','YYYYMMDDHH24MI')\n" +
    ...
    public static String getPersonsByWorkId = "select f_role, f_person from semarchy_eph_mdm.gd_work_person_role gwpr where f_wwork ='%s' and effective_end_date is null";
}
