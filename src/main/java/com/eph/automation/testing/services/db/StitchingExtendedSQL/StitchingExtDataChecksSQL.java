...
//    }
    ...
    public static String GET_RANDOM_EPR_MANIF_EXTENDED ="select epr_id as epr_id from "+GetStitchDLDBUser.getProdExtDB()+".manifestation_extended where delete_flag = false order by rand() limit %s";
