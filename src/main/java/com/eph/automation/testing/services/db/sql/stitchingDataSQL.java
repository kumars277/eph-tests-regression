...
public class stitchingDataSQL {
    public static String GETRandomIds_stch_manifestation_ext_json=
            "select * from (select smej.epr_id, smej.\"json\" from ephsit_extended_data_stitch.stch_manifestation_ext_json smej  \n" +
    ...
    public static String GETRandomIds_stch_product_core_json=
            "select * from(select  epr_id , \"json\" from ephsit_extended_data_stitch.stch_product_core_json " +
    ...
    public static String GETRandomIds_stch_product_ext_json_byAvailability=
            "select * from(select  epr_id ,\"json\" from ephsit_extended_data_stitch.stch_product_ext_json " +
    ...
    public static String GETRandomIds_stch_work_core_json=
            "select * from (select swcj.epr_id, swcj.\"json\" from ephsit_extended_data_stitch.stch_work_core_json swcj  \n" +
                    "inner join semarchy_eph_mdm.gd_product gp on swcj.epr_id =gp.f_wwork \n" +
                    "order by random() limit %s)as result_set order by epr_id asc";

    public static String GETRandomIds_stch_work_ext_json=
            "select * from (select swej.epr_id, swej.\"json\" from ephsit_extended_data_stitch.stch_work_ext_json swej  \n" +
