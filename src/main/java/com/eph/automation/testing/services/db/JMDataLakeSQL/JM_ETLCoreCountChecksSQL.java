...
public class JM_ETLCoreCountChecksSQL {
    ...
    public static String GET_JMF_STAGING_PRODUCT_PART="select count(*) as count from (" +
            ...
            " w.work_chronicle_id, w.elsevier_journal_number, w.work_journey_identifier, wbm.SBS," +
            " wbm.APC, wbm.SBD, m.manifestation_id, w.launch_date, m.manifestation_type, m.elsevier_journal_number," +
            " m.manifestation_title, w.eph_work_id, w.work_title, m.eph_manifestation_id, m.notified_date,w.editorial_effective_date\n" +
            "UNION    SELECT\n" +
            "     cs.chronicle_scenario_name scenario_name\n" +
            "   , cs.chronicle_scenario_code scenario_code\n" +
            "   , (CASE cs.chronicle_scenario_evolutionary_ind WHEN 'N' THEN 'Insert' WHEN 'Y' THEN 'Update' ELSE 'Update' END) upsert\n" +
