...
public class APIDataSQL {
  ...
  public static String SELECT_RANDOM_PRODUCT_IDS_FOR_SEARCH =
      "SELECT product_id as PRODUCT_ID\n"
          + "FROM semarchy_eph_mdm.gd_product WHERE f_manifestation is not null\n"
          + "order by random() limit '%s'";

  public static String EXTRACT_DATA_SUBJECT_AREA_GD_BY_CODE =
  ...
  public static String GET_GD_FinnAttr_DATA =
      "SELECT \n"
  ...
  public static String SELECT_RANDOM_WORK_IDS_FOR_SEARCH =
  ...
  public static String SELECT_RANDOM_WORK_WITH_MANIFESTATION_IDENTIFIER =
  ...
  public static String SELECT_RANDOM_PRODUCT_IDS_WITH_WORK =
      "select product_id as PRODUCT_ID from semarchy_eph_mdm.gd_product "
          + "where f_wwork is not null order by random() limit 1";

  public static String SELECT_RANDOM_PRODUCT_IDS_WITH_PERSON =
  ...
  public static String SELECT_RANDOM_PRODUCT_IDS_WITH_IDENTIFIER =
      "select f_product as PRODUCT_ID from semarchy_eph_mdm.gd_product_identifier "
          + "where f_product is not null order by random() limit 1";

  public static String SELECT_RANDOM_PRODUCT_IDS_WITH_MANIFESTATION_IDENTIFIER =
  ...
  public static String EPH_GD_PRODUCT_EXTRACT_FOR_SEARCH =
      "SELECT \n"
  ...
  public static String EPH_GD_WORK_EXTRACT_FOR_SEARCH =
      "SELECT \n"
          + "               work_id AS WORK_ID,\n"
  ...
  public static String SELECT_PRODUCT_BY_ID =
      "SELECT product_id as PRODUCT_ID FROM semarchy_eph_mdm.gd_product WHERE product_id='%s'";

  public static String SELECT_WORKS_BY_PMC_CODE =
      "SELECT work_id as WORK_ID FROM semarchy_eph_mdm.gd_wwork WHERE f_pmc in ('%s')";

  public static String SELECT_WORK_BY_ID_FOR_SEARCH =
      "SELECT work_id as WORK_ID FROM semarchy_eph_mdm.gd_wwork WHERE work_id='%s'";

  // public static String SELECT_MANIFESTATIONS_IDS_BY_WORKS =      "select manifestation_id as
  // MANIFESTATION_ID from semarchy_eph_mdm.gd_manifestation where f_wwork in ('%s')";

  public static String SELECT_MANIFESTATION_IDS_BY_WORKID =
      "select manifestation_id as manifestation_id from semarchy_eph_mdm.gd_manifestation where f_wwork in ('%s')";

  public static String SELECT_COUNT_PRODUCTS_BY_MANIFESTATIONS =
      "select count (*) from semarchy_eph_mdm.gd_product where f_manifestation in ('%s')";

  public static String SELECT_COUNT_PRODUCTS_BY_WORK =
      "select count (*) from semarchy_eph_mdm.gd_product where f_wwork in ('%s')";

  public static String SELECT_PRODUCT_SEGMENT_CODE_FROM_WORK =
  ...
  public static String SELECT_PRODUCTCOUNT_BY_PRODUCTTYPE =
      "select count(*) from semarchy_eph_mdm.gd_product where s_name like \'%%%s%%\' and f_type='%s'";

  public static String SELECT_RANDOM_PACKAGE_IDS_FOR_SEARCH =
      "select product_id from semarchy_eph_mdm.gd_product "
          + "where f_type ='PKG' and f_status='PAS' "
          + "group by product_id order by random() limit '%s'";

  public static String SELECT_RANDOM_PRODUCT_FROM_PACKAGE =
  ...
  public static String EPH_GD_PACKAGE_COUNT_BY_PRODUCT_EXTRACT =
  ...
  public static String SELECT_RANDOM_WORK_PERSON_ROLES_FOR_SEARCH =
  ...
  public static String SELECT_WORK_COUNT_BY_PERSONID_ACTIVE_ONLY =
      "select count(work_id ) from semarchy_eph_mdm.gd_wwork gw\n"
          + "inner join semarchy_eph_mdm.gd_work_person_role gwpr \n"
          + "on gw.work_id =gwpr.f_wwork \n"
          + "where gw.f_type in('ABS','JBB','JNL','NWL')and gw.f_status in('WLA')\n"
  ...
  public static String SELECT_WORK_COUNT_BY_PERSONID_ALL =
      "select count(work_id ) from semarchy_eph_mdm.gd_wwork gw\n"
          + "inner join semarchy_eph_mdm.gd_work_person_role gwpr \n"
          + "on gw.work_id =gwpr.f_wwork \n"
  ...
  public static String EPH_GD_WORK_EXTRACT_AMOUNT_BYPMC =
      "SELECT COUNT (f_pmc) FROM semarchy_eph_mdm.gd_wwork where f_pmc='%s'";

  public static String EPH_GD_PMG_CODE_EXTRACT_BYPMC =
      "select f_pmg from semarchy_eph_mdm.gd_x_lov_pmc where code='%s'";

  public static String EPH_GD_PMG_CODE_WORKS_EXTRACT_BY_PMC =
  ...
  public static String EPH_GD_WORK_EXTRACT_BY_SEARCH_WITH_PMCCODE =
      "select COUNT(*) from semarchy_eph_mdm.gd_wwork where UPPER(work_title) like '%%%S%%' AND f_pmc='%s'";
  public static String EPH_GD_WORK_EXTRACT_BY_SEARCH_WITH_PMGCODE =
  ...
  public static String EPH_GD_WORK_EXTRACT_BY_ACCOUNTABLE_PRODUCT =
  ...
  public static String EPH_GD_WORK_EXTRACT_FOR_SEARCH_BY_MANIFESTATIONID =
      "SELECT \n"
          + "               work_id AS WORK_ID,\n"
          + "               work_title AS WORK_TITLE,\n"
          + "               work_sub_title AS WORK_SUBTITLE,\n"
  ...
  public static String getWorkIdentifiersDataFromGD =
      "SELECT \n"
          + " F_EVENT as F_EVENT\n"
          + " ,B_CLASSNAME as B_CLASSNAME\n"
  ...
  public static String getProductIdentifiersDataFromGD =
      "SELECT \n"
          + " F_EVENT as F_EVENT\n"
          + " ,B_CLASSNAME as B_CLASSNAME\n"
          + " ,IDENTIFIER AS IDENTIFIER --  IDENTIFIER\n"
  ...
  public static String getWorkLegelOwnersByWorkId =
      "select "
  ...
  public static String SelectProductByWorkId =
      "SELECT \n"
          + "              product_id AS PRODUCT_ID -- Title\n"
          + "              ,name as PRODUCT_NAME\n"
          + "              ,separately_sale_indicator as SEPARATELY_SALEABLE_IND\n"
  ...
  public static String selectWorkPersonByworkId =
      "Select "
  ...
  public static String SelectPersonDataByPersonId =
      "select "
