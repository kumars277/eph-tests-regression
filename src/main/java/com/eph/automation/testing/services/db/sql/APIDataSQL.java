...
public class APIDataSQL {
  ...
  public static final String SELET_GD_COUNT_WORK_BY_PERSONNAME_withExtendedperson =
      "with totalWorks as (\n"
          + "    with extendedPersons as (\n"
          + "        select\n"
          + "            epr_id,\n"
          + "            json_array_elements(\n"
          ...
          + "            epr_id,\n"
          + "            concat(\n"
          + "                concat(cast(person as JSON) ->> 'firstName', ' '),\n"
          + "                cast(person as JSON) ->> 'lastName'\n"
          + "            ) as name\n"
          + "        from\n"
          + "            extendedPersons\n"
          + "    )\n"
          ...
          + "        distinct work_id\n"
          + "    from\n"
          + "        semarchy_eph_mdm.gd_wwork gw\n"
          + "        inner join semarchy_eph_mdm.gd_work_person_role gwpr on gw.work_id = gwpr.f_wwork\n"
          + "    where\n"
          + "        gw.f_type in('ABS', 'JBB', 'JNL', 'NWL')\n"
          + "        and gw.f_status in('WLA')\n"
          + "        and gwpr.f_person in (\n"
          + "            select\n"
          + "                person_id\n"
