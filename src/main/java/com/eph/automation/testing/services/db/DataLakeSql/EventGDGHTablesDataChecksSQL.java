...
public  class EventGDGHTablesDataChecksSQL {
    ...
    public static String GET_DATA_EVENT_EPH = "select \n" +
            ...
            "from semarchy_eph_mdm.gd_event\n" +
            " where EVENT_ID in ('%s')";

    public static String GET_DATA_EVENT_DL = "select \n" +
            "EVENT_ID as EVENT_ID\n" +
            ",B_CLASSNAME as B_CLASSNAME\n" +
            ",B_BATCHID as B_BATCHID\n" +
            ",B_CREDATE as B_CREDATE\n" +
            ...
            ",F_SELF_THREE as F_SELF_THREE\n" +
            ",F_SELF_FOUR as F_SELF_FOUR\n" +
            "from "+ GetDLDBUser.getDataBase()+".gd_event\n" +
            "where EVENT_ID in ('%s')";
}
