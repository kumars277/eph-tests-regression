...
public class ProductDataSQL {
    ...
    public static String EPH_SA_PRODUCT_EXTRACT_JOURNALS = "SELECT \n" +
            "   sa.B_LOADID AS LOADID\n" +
            "  ,F_EVENT AS F_EVENT\n" +
            "  ,sa.B_CLASSNAME as B_CLASSNAME\n" +
            "  ,product_id AS PRODUCT_ID -- Title\n" +
    ...
    public static String SELECT_F_PRODUCT_WORK_IDS_FOR_GIVEN_MANIFESTATION_IDS = "select \"F_PRODUCT_WORK\" as F_PRODUCT_WORK from ephsit_talend_owner.stg_pmx_product where \"PRODUCT_MANIFESTATION_ID\" IN ('%s')";
