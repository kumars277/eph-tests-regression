...
public class CKCMMSInboundDataCheckSQL {
    //CKCMMSInbound Data IDs SQL
    public static String GET_CMMS_INBOUND_URL1_VIEW_IDs = "select cmms_issn_isbn as u_key from " + GetCKDLDB.getCKDataBase() +  ".%s limit %s";
    public static String GET_CMMS_INBOUND_URL2_VIEW_IDs = "select cmms_issn_isbn as u_key from " + GetCKDLDB.getCKDataBase() +  ".%s limit %s";
    public static String GET_CMMS_INBOUND_URL3_VIEW_IDs = "select u_key from " + GetCKDLDB.getCKDataBase() +  ".%s limit %s";
    public static String GET_CMMS_INBOUND_URL_TRANSFORM_VIEW_IDs = "select u_key from " + GetCKDLDB.getCKDataBase() +  ".%s limit %s";


    //CKCMMSInbound View Data  SQL
    public static String GET_CMMS_INBOUND_URL1_VIEW_Data = "Select * from " + GetCKDLDB.getCKDataBase() +  " .%s where cmms_issn_isbn in ('%s')";

    public static String GET_CMMS_INBOUND_URL2_VIEW_DATA = "Select * from " + GetCKDLDB.getCKDataBase() +  " .%s where cmms_issn_isbn in ('%s')";
    public static String GET_CMMS_INBOUND_URL3_VIEW_DATA ="Select * from  " + GetCKDLDB.getCKDataBase() +  " .%s where u_key in ('%s')";
    public static String GET_CMMS_INBOUND_URL_TRANSFORM_VIEW_DATA ="Select * from  " + GetCKDLDB.getCKDataBase() +  " .%s where u_key in ('%s')";



    //CKCMMSInbound Query Data  SQL
    public static String GET_CKCMMS_INBOUND_URL1_QUERY_DATA = "Select * from(\n" +
            "   SELECT\n" +
            ...
            ") where cmms_issn_isbn in ('%s')";
    public static String GET_CKCMMS_INBOUND_URL2_QUERY_DATA = "select * from(\n" +
            "   SELECT\n" +
            ...
            "   ORDER BY u_key ASC\n" +
            ") where cmms_issn_isbn in ('%s')";
    public static String GET_CKCMMS_INBOUND_URL3_QUERY_DATA ="Select * from (\n" +
            "   SELECT\n" +
            "     eph_package_id\n" +
            "   , eph_work_id\n" +
            "   , durable_url\n" +
            ...
            "   ORDER BY u_key ASC\n" +
            ")  where u_key in ('%s')";
    public static String GET_CKCMMS_INBOUND_URL_TRANSFORM_QUERY_DATA ="Select * from (\n" +
            "   SELECT\n" +
            "     eph_package_id\n" +
            "   , eph_work_id\n" +
            "   , durable_url\n" +
